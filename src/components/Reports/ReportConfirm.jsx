    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-4">
        <div className="bg-dark-bg dark:bg-dark-bg rounded-xl p-4 border border-dark-border flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-dark-text dark:text-dark-text flex items-center gap-1">
          ...
          <div>
            <label
              htmlFor="description"
              className="text-xs text-muted-dark dark:text-muted-dark block mb-1"
            >
            ...
            <textarea
              ...
              rows={3}
              className="w-full p-3 bg-dark-bg dark:bg-dark-bg border border-dark-border rounded-lg text-sm text-dark-text dark:text-dark-text placeholder:text-muted-dark dark:placeholder:text-muted-dark resize-none focus:outline-none focus:border-emergency"
            />
          </div>
        </div>
      </div>
      <div className="p-4 flex gap-3">
        <button
          type="button"
          onClick={onBack}
          className="py-3 px-4 rounded-xl border border-dark-border text-dark-text dark:text-dark-text text-sm"
          disabled={submitting}
        >
          ← Back
        </button>
