      ...
      {TYPES.map(({ id, label, icon: Icon }) => (
        ...
        >
          <Icon
            ...
            className={
              selected === id ? 'text-emergency dark:text-emergency-dark' : 'text-text-muted-dark'
            }
            aria-hidden="true"
          />
          <span
            className={`text-sm font-medium ${selected === id ? 'text-emergency dark:text-emergency-dark' : 'text-text-dark'}`}
          >
            {label}
          </span>
        </button>
