...
export default function AnnouncementCard({ announcement }) {
  const { type, title, body, severity = 'info', scope, createdAt } = announcement;
  ...
  return (
    <div
      className={`border-l-4 rounded-lg bg-white dark:bg-dark-card shadow-card overflow-hidden p-3.5 ${SEVERITY_STYLES[severity] || SEVERITY_STYLES.info}`}
    >
