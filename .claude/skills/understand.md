...
1. Before writing the assembled graph, validate that:
   ...
   If validation fails, automatically normalize and rewrite the graph into this shape before saving.
...
- Track all warnings and errors from each phase in a `$PHASE_WARNINGS` list.
